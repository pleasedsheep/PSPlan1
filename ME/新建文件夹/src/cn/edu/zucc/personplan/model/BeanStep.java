...
public class BeanStep {
	...
	public String getCell(int col){
		if(col==0) return getStep_order() + "";
		else if(col==1) return getStep_name();
		else if(col==2) return getPlan_begin_time() + "";
		else if(col==3) return getPlan_end_time() + "";
		else if(col==4) return getReal_begin_time() + "";
		else if(col==5) return getReal_end_time() + "";
