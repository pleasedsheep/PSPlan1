...
public class FrmHallManager_Addhall extends JDialog implements ActionListener {
	...
	private JLabel labelReaderid = new JLabel("餐厅编号：");
	private JLabel labelReaderName = new JLabel("所属区域：");
	private JLabel labelReaderType = new JLabel("餐厅名称：");
	private JLabel labelReaderintro = new JLabel("餐厅介绍：");
	private JLabel labelReaderdish = new JLabel("特色菜品：");
	private JLabel labelReaderavpri = new JLabel("人均消费：");
	...
	public FrmHallManager_Addhall(JDialog f, String s, boolean b,Map<String,BeanReaderType> rtMap) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			if(this.cmbReadertype.getSelectedIndex()<0){
				JOptionPane.showMessageDialog(null, "请选择","错误",JOptionPane.ERROR_MESSAGE);
				return;
			}
