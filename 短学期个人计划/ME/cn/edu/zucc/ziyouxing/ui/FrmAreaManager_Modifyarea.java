...
public class FrmAreaManager_Modifyarea extends JDialog implements ActionListener {
	...
	public FrmAreaManager_Modifyarea(JDialog f, String s, boolean b,BeanPublisher p) {
		super(f, s, b);
		this.pub=p;
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				FrmAreaManager_Modifyarea.this.pub=null;
			}
		});
	}
	@Override
