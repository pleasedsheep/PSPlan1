...
public class FrmReturn extends JDialog implements ActionListener {
	...
	private Object tblTitle[]={"产品编号","线路编号","出发日期","金额"};
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnReturn){
			...
			if(!"已被选定".equals(this.lableBookState.getText())){
				JOptionPane.showMessageDialog(null,"产品没有被选定","错误",JOptionPane.ERROR_MESSAGE);
				return;
			}
			try {
