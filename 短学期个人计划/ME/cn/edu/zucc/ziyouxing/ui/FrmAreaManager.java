...
public class FrmAreaManager extends JDialog implements ActionListener {
	private JPanel toolBar = new JPanel();
	private Button btnAdd = new Button("添加区域");
	private Button btnModify = new Button("修改区域信息");
	private Button btnDelete = new Button("删除区域");
	private Object tblTitle[]={"区域ID","名称"};
	...
	public FrmAreaManager(Frame f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnAdd){
			FrmAreaManager_Addarea dlg=new FrmAreaManager_Addarea(this,"添加出版社",true);
			dlg.setVisible(true);
			...
			FrmAreaManager_Modifyarea dlg=new FrmAreaManager_Modifyarea(this,"添加读者类别",true,p);
			dlg.setVisible(true);
			if(dlg.getPub()!=null){//刷新表格
				this.reloadTable();
			}
