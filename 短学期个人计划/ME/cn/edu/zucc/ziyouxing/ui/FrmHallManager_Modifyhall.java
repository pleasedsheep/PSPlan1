...
public class FrmHallManager_Modifyhall extends JDialog implements ActionListener {
	...
	public FrmHallManager_Modifyhall(JDialog f, String s, boolean b,Map<String,BeanReaderType> rtMap,BeanReader r) {
		super(f, s, b);
		this.reader=r;
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				FrmHallManager_Modifyhall.this.reader=null;
			}
		});
	}
	@Override
