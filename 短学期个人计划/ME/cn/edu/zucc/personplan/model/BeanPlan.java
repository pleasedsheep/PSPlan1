...
public class BeanPlan {
	public static final String[] tableTitles={"序号","名称","步骤数","已开始数","已完成数","创建时间"};
	/**
	...
	public String getCell(int col){
		if(col==0) return getPlan_order() + "";
		else if(col==1) return getPlan_name();
		else if(col==2) return getStep_count() + "";
		else if(col==3) return getStart_step_count() + "";
		else if(col==4) return getFinished_step_count() + "";
		else if(col==5) return getCreate_time() + "";
		else return "";
	}
